...
// count prompt-cache hits toward the rate limits, and this block is ~1,200
// tokens, so caching it is the difference between roughly 2 and 5 requests per
// minute of headroom against the 6,000 TPM ceiling on llama-3.1-8b-instant.
//
